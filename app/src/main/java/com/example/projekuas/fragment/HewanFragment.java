...
public class HewanFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view,
        ...
        chipGroup = view.findViewById(R.id.chipGroupHewan);
        ...
        // Load pertama
        currentList = repository.getHewan();
    ...
    private void loadRegion() {
        ...
        if (currentRegion.equals("Semua")) {
            ...
            currentList = repository.getByRegion("Hewan", currentRegion);
